      ...
      <div className="anim-1 flex items-start justify-between">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">
            {initialPatients?.length || 0} patients registered in the system
          </p>
        </div>
        ...
        {patients?.length === 0 ? (
          <div className="card p-14 text-center">
            ...
            <p className="font-semibold text-slate-400">
              {query ? "No results found" : "No patients registered yet"}
            </p>
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 flex-wrap">
                          <p className="font-semibold text-white group-hover:text-brand-300 transition-colors text-sm">
                            {p?.fullName}
                          </p>
                        ...
                        {lastVisit && (
                          <div className="text-right">
                            ...
                            <p className="text-slate-400 font-medium">
                              {fmtDateShort(lastVisit?.visitDate)}
                            </p>
                          </div>
                        )}
                      </div>
                      ...
                      <ChevronRight
                        size={15}
                        className="text-slate-700 group-hover:text-brand-400 group-hover:translate-x-0.5 transition-all flex-shrink-0"
                      />
                    </Link>
                  </motion.div>
                );
